...
<body>
    ...
    <header>
        ...
        <h3>
        <?php
        //Our php for displaying the name using POST method  
        if (isset($_POST["name"]) && !empty($_POST["name"])) {
            echo htmlspecialchars($_POST["name"]); // Display the name safely
        } else {
        ...
        <ul class="navbar">
            ...
            <li><a href="#login" id="login">Login</a></li> <!--And this-->
            <li><a href="#rate" id="rate">Comment</a></li> <!--And this-->
            <!--<li><a href="urComment.php" id="comments">Ur Feedback</a></li> And this-->
        </ul>
    ...
    <div class="form">
        ...
        <form action="ideaProfile.php" method="POST">
           ...
           <small>Don't have account yet?<a href="#"> Create Account</a></small>
        </form>
        <!-- Form ends here -->
        <h2>˖⁺‧₊˚♡˚₊‧⁺˖♡︎˖⁺‧₊˚♡˚₊‧⁺˖</h2>
    </div>
...
<div class="popup-comment">
    ...
    <form action="urComment.php" method="GET">
            <div class="form-element-comment">
            <label for="text">Comment</label>
            <textarea id="text" name="comment" placeholder="Share your insight with us"></textarea>
            </div>
           <div class="form-element-comment">
